...
let Draggable = {
    ...
    addDraggable: function(){
        $(".draggable").draggable({
            ...
            drag: function(e, ui) {
                ...
                // console.log((dist_click < 20 || dist_click > 80), !$(this).hasClass("ui-draggable-dragging"), $(this).hasClass("ui-draggable-disabled"))
                ...
                let max_top_drag = $('#drag_body').height() - ui.helper.height();
    ...
    addSVG: function(e, clear = true){
        ...
        let y2 = $(e).offset().top + $(e).height()/2;
        
        let line = makeSVG('line', {x1: this.x1, y1: this.y1, x2:x2, y2:y2, stroke: 'black', 'stroke-width': 2, 'id': "line_"+this.lineId});
        $("svg").append(line);
    ...
    events: function(){
        ...
        $("html").on("mousemove", function(e){
            if(self.x1 && self.y1){
                ...
                $("#line_"+self.line_selected).attr("x2", self.x2)
                $("#line_"+self.line_selected).attr("y2", self.y2)
            }
        });
    }
}
